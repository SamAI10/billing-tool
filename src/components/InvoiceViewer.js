  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div className="relative top-20 mx-auto p-8 w-full max-w-4xl">
        <div className="bg-white rounded-lg shadow p-8" ref={componentRef}>
          ...
          <div className="flex justify-between mb-8">
            ...
            <div className="text-right">
              <h2 className="font-bold mb-2">Votre Entreprise</h2>
          ...
          <table className="w-full mb-8">
            ...
            <tfoot>
              <tr className="font-bold">
                ...
                <td className="text-right py-4">{calculateTotal(invoice.items).toFixed(2)} €</td>
              </tr>
            </tfoot>
          </table>
